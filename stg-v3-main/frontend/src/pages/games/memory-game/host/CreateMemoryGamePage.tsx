...
export default function CreateMemoryGamePage() {
  ...
  return (
    <Form className="d-flex flex-column gap-3" onSubmit={handleSubmit}>
      <div>
        <h2 className="fs-4 mb-0">{_(msg`Memory Game`)}</h2>
      ...
      <p>
        <Trans>
          Memory game is a fun and interactive game that helps you to improve
          your memory and focus. It is a great way to challenge yourself and

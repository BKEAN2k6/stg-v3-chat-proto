...
import CategorySelectModal from './CategorySelectModal.js';
...
export default function CategorySelect(properties: Properties) {
  const {selectedCategory, onChange, isRootSelectable, excludeCategoryIds} =
    properties;

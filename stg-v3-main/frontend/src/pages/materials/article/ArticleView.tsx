...
import LockedArticleOverlay from '@/components/ui/LockedArticleOverlay.js';
    ...
    <div>
      ...
      {content.length > 1 ? (
        ...
        <div
          style={{
            position: 'relative',
            maxHeight: isLocked ? '300px' : undefined,
            overflow: isLocked ? 'hidden' : undefined,
          }}
        >
          <MarkdownView content={content[0]} />
          {isLocked ? <LockedArticleOverlay /> : null}
        </div>
      )}
    </div>
  );

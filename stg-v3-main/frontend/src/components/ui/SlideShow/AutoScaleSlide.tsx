...
import LockedOverlay from '@/components/ui/LockedOverlay.js';
...
export default function AutoScaleSlide({
  ...
  const shadow = shadowColor ?? 'white';
  const contentStyle: CSSProperties = {
    textShadow: `0 0 0.5cqw ${shadow}, 0 0 1cqw ${shadow}, 0 0 1.25cqw ${shadow}`,
  };

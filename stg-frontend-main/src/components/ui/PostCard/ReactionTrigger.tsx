...
import {type UserInfo, type Moment, type Reaction} from '@/api/ApiTypes';
import {reactionIcons, reactionTypes} from '@/helpers/reactions';
...
export default function ReactionTrigger(props: Props) {
  ...
  const usersReaction = reactions.find(
    (reaction) => reaction.createdBy._id === currentUser?._id,
  );

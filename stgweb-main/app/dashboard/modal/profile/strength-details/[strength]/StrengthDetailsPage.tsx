...
const texts = {
  ...
  signatureStrengthsText: {
    'en-US': 'These are my signature strengths.',
    'sv-SE': 'Det här är mina kärnstyrkor.',
    'fi-FI': 'Nämä ovat ydinvahvuuteni.',
  },
  goBackText: {
    'en-US': 'Go back',
    'sv-SE': 'Gå tillbaka',

...
import {mapLocaleCodeToLanguageCode, type LocaleCode} from '@/lib/locale';
...
export const V1LessonMaterial = (props: V1LessonMaterialProps) => {
  ...
  return (
    <div className="max-w-2xl">
      <a
        href={`https://go.seethegood.app/kfk3832ngvdsQoerhA938Gr/learn/students-v2?lang=${languageCode}`}
        rel="noreferrer"
        target="_blank"

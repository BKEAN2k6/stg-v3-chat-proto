...
const texts = {
  title1: {
    'en-US': 'Time to see strengths in others!',
    'fi-FI': 'Aika huomata vahvuuksia muissa!',
    'sv-SE': 'Dags att se styrkorna i andra!',
  },
  continue: {
    'en-US': 'Continue',
    'fi-FI': 'Jatka',
...
export default async function GamesSessionPlayerSessionIdPeerStrengthsStartPage(
  props: Props,
) {
        ...
        <FullHeightCentered requiredHeight={320}>
          <div className="flex flex-col">
            ...
            <div className="mt-16 flex justify-center">
              <ButtonWithTarget
                target={sp(PATHS.strengthSessionPlayerPeerStrengths, sessionId)}

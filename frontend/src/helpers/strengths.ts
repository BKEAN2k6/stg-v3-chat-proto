...
export const strengthSlugs: StrengthSlug[] = [
  'carefulness',
  'compassion',
  'courage',
  'creativity',
...
export const strengthGroups: StrengthGroup[] = [
  'wisdom',
  'humanity',
  'justice',
  'courage',
...
export const strengthSlugToGroup: Record<StrengthSlug, StrengthGroup> = {
  carefulness: 'temperance',
  compassion: 'humanity',
  courage: 'courage',
  creativity: 'wisdom',
  curiosity: 'wisdom',
  ...
  honesty: 'courage',
  hope: 'transcendence',
  humour: 'transcendence',
  judgement: 'wisdom',
  kindness: 'humanity',
  leadership: 'justice',
  love: 'humanity',
  loveOfBeauty: 'transcendence',
  loveOfLearning: 'wisdom',
  modesty: 'temperance',
  perseverance: 'courage',
  perspective: 'wisdom',
  selfRegulation: 'temperance',
  socialIntelligence: 'humanity',
  spirituality: 'transcendence',
  teamwork: 'justice',
};

export const simpleStrengthSlugs: StrengthSlug[] = [
  'kindness',
  'creativity',
  'humour',
  'courage',
...
export const strengthColorMap: Record<StrengthSlug, Record<string, string>> = {
  carefulness: {
    '100': '#e7f3e6',
    '300': '#d7ebd6',
    '500': '#bcdebe',
...
export const strengthGroupTranslationMap: Record<
  StrengthGroup,
...
export const strengthGroupColorMap: Record<
  StrengthGroup,
...
export const strengthTranslationMap: Record<
  StrengthSlug | 'like',
  Record<LanguageCode, string>
> = {
  like: {
...
export const strengthFinnishCasesMap: Record<
  StrengthSlug,
  Record<string, string>
> = {
  creativity: {
...
export const strengthFactsMap: Record<
  StrengthSlug,
  Record<LanguageCode, string>
> = {
  carefulness: {
...
export const strengthExamplesMap: Record<
  StrengthSlug,
  Record<LanguageCode, string>
> = {
  carefulness: {
...
export const strengthAdjectivesMap: Record<
  StrengthSlug,
  Record<LanguageCode, string>
> = {
  carefulness: {

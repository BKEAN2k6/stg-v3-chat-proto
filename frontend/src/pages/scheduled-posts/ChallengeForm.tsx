...
import ChallengeContent from '@/components/ui/PostCard/ChallengeContent.js';
import StrengthModal from '@/components/ui/StrengthModal.js';

type Properties = {
  readonly challengeData: CreateChallengeRequest;
  readonly onUpdate: (updatedChallenge: CreateChallengeRequest) => void;
};

export function ChallengeForm({challengeData, onUpdate}: Properties) {

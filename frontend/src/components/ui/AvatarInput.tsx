...
export default function AvatarInput(properties: AvatarInputProperties) {
  const {_} = useLingui();
  const {className, existingAvatar, onSave, onDelete} = properties;
  ...
  const editorReference = useRef<AvatarEditor>(null);
  ...
  const handleSave = async () => {
    ...
    const canvas = editorReference.current.getImageScaledToCanvas();

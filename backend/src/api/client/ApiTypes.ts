...
export type CoachingBasePrompt = {
  id: string;
  name: string;
  content: string;
  createdAt?: string;
...
export type GetCoachingPlansResponse = CoachingPlan[];
export type CreateCoachingPlanResponse = CoachingPlan;
export type CreateCoachingPlanRequest = {
  title: string;
  description: string;
  content: string;
  basePromptId: string;
...
export type GetCoachingPlanParameters = {
  id: string;
};
export type GetCoachingPlanResponse = CoachingPlan;
export type UpdateCoachingPlanParameters = {
  id: string;
};
export type UpdateCoachingPlanResponse = CoachingPlan;
export type UpdateCoachingPlanRequest = {
  title?: string;
  description?: string;
  content?: string;
  basePromptId?: string;
...
export type RemoveCoachingPlanParameters = {
  id: string;
};
export type GetCoachingSessionsResponse = CoachingSession[];
export type CreateCoachingSessionResponse = CoachingSession;
export type CreateCoachingSessionRequest = {
  planId: string;
};
export type GetCoachingSessionParameters = {
  id: string;
};
export type GetCoachingSessionResponse = CoachingSession;
export type UpdateCoachingSessionParameters = {
  id: string;
};
export type UpdateCoachingSessionResponse = CoachingSession;
export type UpdateCoachingSessionRequest = {
  status?: 'active' | 'completed' | 'abandoned';
};
export type RemoveCoachingSessionParameters = {
  id: string;
};
export type SendCoachingMessageParameters = {
  id: string;
};
export type SendCoachingMessageResponse = {
  message: string;
...
export type SendCoachingMessageRequest = {
  content: string;
  retryContext?: {
    malformedResponse: string;
    validationError: string;
...
export type GetAvailableCoachingPlansResponse = Array<{
  id: string;
  title: string;
  description: string;
}>;
export type GetAllCoachingSessionsResponse = Array<{
  id: string;
  planTitle: string;
  planDescription?: string;
  planContent?: string;
...
export type GetCoachingBasePromptsResponse = CoachingBasePrompt[];
export type CreateCoachingBasePromptResponse = CoachingBasePrompt;
export type CreateCoachingBasePromptRequest = {
  name: string;
  content: string;
};
export type GetCoachingBasePromptParameters = {
  id: string;
};
export type GetCoachingBasePromptResponse = CoachingBasePrompt;
export type UpdateCoachingBasePromptParameters = {
  id: string;
};
export type UpdateCoachingBasePromptResponse = CoachingBasePrompt;
export type UpdateCoachingBasePromptRequest = {
  name?: string;
  content?: string;
};
export type RemoveCoachingBasePromptParameters = {
  id: string;
};

...
import coachingPlanController from './coaching-plan/index.js';
import coachingSessionController from './coaching-session/index.js';
import coachingBasePromptController from './coaching-base-prompt/index.js';
...
const routes: RouteConfigs = {
  ...
  ...coachingPlanController,
  ...coachingSessionController,
  ...coachingBasePromptController,
};

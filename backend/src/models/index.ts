...
import {CoachingPlan} from './CoachingPlan.js';
import {CoachingSession} from './CoachingSession.js';
...
const CoachingPlanModel = getModelForClass(CoachingPlan);
const CoachingSessionModel = getModelForClass(CoachingSession);
const CoachingBasePromptModel = getModelForClass(CoachingBasePrompt);
...
export {
  ...
  CoachingPlanModel as CoachingPlan,
  CoachingSessionModel as CoachingSession,
  CoachingBasePromptModel as CoachingBasePrompt,
};
